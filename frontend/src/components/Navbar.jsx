...
import { Ghost, Home, LayoutGrid, Users, LogIn, Heart, Sparkles } from 'lucide-react';
        ...
        <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-6 px-4">
            <div className="glass-panel rounded-full px-6 py-3 flex items-center gap-8 shadow-soft border-2 border-white/50 bg-white/80 backdrop-blur-xl">
                ...
                <div className="hidden md:flex items-center gap-2">
                    ...
                    <NavLink to="/pokedex" icon={LayoutGrid} label="Pokedex" />
                ...
                <div className="flex items-center gap-4">
                    <Link to="/login">
                        <button className="glass-button rounded-full px-6 py-2 text-sm hover:shadow-md">
                            Login
                        </button>
                    </Link>
                </div>
